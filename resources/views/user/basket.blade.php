        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach ($basket as $bPoint)
                    <tr>
                        <th scope="row">{{ $num++ }}</th>
                        <td><a href="{{ route('seeProduct', ['id' => $bPoint->product_id]) }}">{{ $bPoint->name }}</a></td>
                        <td>{{ $bPoint->cost }}₽</td>
                        <td>{{ $bPoint->count }}</td>
                        <td>
                            <input type="checkbox" name="addToOrder_{{$bPoint->id}}" id="addToOrder_{{$bPoint->id}}" checked>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach ($orders as $order)
                    <tr>
                        <th scope="row">{{ $num++ }}</th>
                        <td><a href="{{ route('seeOrder', ['track_number' => $order->track_number]) }}">{{ $order->track_number }}</a>
                        </td>
